...
protected:
	...
	sf::Keyboard::Key buttonL;
	sf::Keyboard::Key buttonR;

public:

	Player(const std::string& name = "", int playerId = 1);
	...
	void SetKeySetting(sf::Keyboard::Key buttonL, sf::Keyboard::Key buttonR);
